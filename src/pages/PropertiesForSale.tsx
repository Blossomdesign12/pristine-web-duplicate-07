        ...
        <section className="container">
          <div className="bg-white p-4 rounded-lg shadow-sm mb-6 flex flex-col sm:flex-row justify-between items-center gap-4">
            <div className="text-gray-600">
              <p>Showing <span className="font-medium text-black">{properties.length}</span> properties for sale</p>
            </div>
          ...
          {currentProperties.length > 0 ? (
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm text-center">
              ...
              <p className="text-gray-600 mb-6">
                We couldn't find any properties for sale matching your search criteria. Try adjusting your filters or search terms.
              </p>
              <Button 
                onClick={() => window.location.href = '/properties-for-sale'}
