...
import { propertiesForSale } from '@/lib/dummy-properties';
...
const PropertiesForSale = () => {
  ...
  useEffect(() => {
    ...
    // Filter properties for sale based on search parameters
    let filteredProperties = [...propertiesForSale];
        ...
        <section className="py-16 bg-estate-light">
          <div className="container">
            <div className="text-center mb-10">
              <h1 className="text-3xl md:text-4xl font-bold mb-3">Properties For Sale</h1>
              <p className="text-estate-gray max-w-2xl mx-auto">
                Find your dream property for sale in Mumbai and surrounding areas
              </p>
            </div>
            
            <PropertySearch initialStatus="for-sale" />
          </div>
        </section>
