        ...
        <section className="bg-black py-12 md:py-20">
          <div className="container text-center">
            ...
            <p className="text-lg text-white/80 max-w-2xl mx-auto">
              Explore our collection of properties available for rent. Find your perfect rental today.
            </p>
          </div>
        </section>
        ...
        <section className="container">
          <div className="bg-white p-4 rounded-lg shadow-sm mb-6 flex flex-col sm:flex-row justify-between items-center gap-4">
            <div className="text-gray-600">
              <p>
                Showing <span className="font-medium text-black">{properties.length}</span> properties for rent
              </p>
            </div>
          ...
          {isLoading ? (
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm text-center">
              ...
              <p className="text-gray-600 mb-6">
                We couldn't find any properties for rent at the moment. Please check back later.
              </p>
