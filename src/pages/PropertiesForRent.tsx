...
const PropertiesForRent = () => {
  ...
  useEffect(() => {
    ...
    // Search properties based on filters, include only properties for rent
    ...
    <Layout>
      <main className="flex-grow pt-20 pb-16">
        ...
        <section className="bg-black py-12 md:py-20">
          <div className="container text-center">
            ...
            <p className="text-lg text-white/80 max-w-2xl mx-auto">
              Explore our collection of properties available for rent. Find your perfect home today.
            </p>
          </div>
        </section>
        ...
        <section className="container -mt-8 mb-12">
          <PropertySearch defaultStatus="for-rent" />
        </section>
        ...
        <section className="container">
          <div className="bg-white p-4 rounded-lg shadow-sm mb-6 flex flex-col sm:flex-row justify-between items-center gap-4">
            <div className="text-gray-600">
              <p>Showing <span className="font-medium text-black">{properties.length}</span> properties for rent</p>
            </div>
          ...
          {currentProperties.length > 0 ? (
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm text-center">
              ...
              <p className="text-gray-600 mb-6">
                We couldn't find any properties for rent matching your search criteria. Try adjusting your filters or search terms.
              </p>
              <Button 
                onClick={() => window.location.href = '/properties-for-rent'}
